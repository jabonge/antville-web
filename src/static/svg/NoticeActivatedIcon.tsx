...
function NoticeActivatedIcon(props: any) {
  return (
    <svg width={28} height={34} fill="none" {...props}>
      ...
      />
      <circle cx={21} cy={6} r={4} fill="#FC6B6B" />
    </svg>
  )
}

const MemoNoticeActivatedIcon = React.memo(NoticeActivatedIcon)
export default MemoNoticeActivatedIcon
